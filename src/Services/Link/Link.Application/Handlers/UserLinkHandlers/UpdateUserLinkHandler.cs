...
public sealed class UpdateUserLinkHandler : IRequestHandler<UpdateLinkCategoryCommand, bool>
{
    private readonly IRepository<LinkCategory> _repository;
    private readonly IMapper _mapper;

    public UpdateUserLinkHandler(IRepository<LinkCategory> repository, IMapper mapper)
    {
